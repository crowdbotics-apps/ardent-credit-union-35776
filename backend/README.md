...
## Project Structure
    ...
    ├── ardent_credit_union_35776  # Django project configurations
...
1. Clone this repo and `cd ardent_credit_union_35776`
...
2. Clone this repo and `cd ardent_credit_union_35776`
